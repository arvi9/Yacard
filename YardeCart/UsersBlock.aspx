<%@ Page Title="Yard eCart Admin Page" Language="C#" MasterPageFile="~/YardeAdmin.Master" AutoEventWireup="true" CodeBehind="UsersBlock.aspx.cs" Inherits="YardeCart.UsersBlock" %>

<asp:content runat="server" id="BodyContent" contentplaceholderid="MainContent">

    <div>
        <table style="width:100%;">
            <tr style="background-color: #006600; color: #FFFFFF; font-size: large; height: 25px; width:100%; text-align: center;"><td>BLOCK USERS  </td></tr>
            <tr><td>
