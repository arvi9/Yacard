    ...
    <div>
        <table style="width:900px;text-align: center;" id="Table1" runat="server">
            ...
            <tr>
                ...
                &nbsp;&nbsp;<asp:Button ID="btnSearch" runat="server" Text="Search Ads" OnClick="btnSearch_Click" Font-Bold="true" BorderColor="Black" BorderStyle="Ridge" BorderWidth="1px" Height="32px" Width="105px" TabIndex="2"  />&nbsp;&nbsp;
