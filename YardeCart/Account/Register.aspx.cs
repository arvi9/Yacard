...
namespace YardeCart.Account
{
    public partial class Register : Page
    {
        ...
        void SendMailtoUser(int UserId)
        {
            ...
            string serverPath = ConfigurationManager.AppSettings["ApplicationPath"].ToString() + "/Account/ActivateUser.aspx?uid=" + UtilityClass.Encrypt(UserId.ToString()).ToString();
